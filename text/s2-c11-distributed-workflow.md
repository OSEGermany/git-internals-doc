...
![All developers push to a single server](../artwork/vector/workflow-star.eps)
...
![Approved features gradually make their way up the ladder](../artwork/vector/workflow-dictator.eps)
...
![Private and public repositories driven by read-only pull requests](../artwork/vector/integration-manager.eps)
